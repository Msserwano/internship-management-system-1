...
import {
  FileText, Upload, Download, Eye, CheckCircle2, AlertCircle, Trash2, FileCode
} from "lucide-react";
...
const INITIAL_DOCS = [
  ...
  { id: "D5", name: "Cover Letter for KCCA", type: "Cover Letter", filename: "cover_letter_ict.pdf", size: "310 KB", status: "pending", date: "2026-07-10" },
  { id: "D6", name: "Recent Passport Photo", type: "Passport Photo", filename: "passport_photo.jpg", size: "650 KB", status: "verified", date: "2026-07-01" },
];
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm">
            Manage your official documents uploaded for KCCA internship verification.
          </p>
        </div>
        ...
        {docs.map((doc, idx) => (
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">{doc.filename} • {doc.size}</p>
            </div>
        ...
        <Modal open={!!previewDoc} onClose={() => setPreviewDoc(null)} title={previewDoc.name} size="lg">
          <div className="p-6 text-center space-y-4">
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-slate-100 dark:border-slate-700">
              ...
              <Button variant="primary" size="sm" onClick={() => toast.success("Downloading file...")} icon={Download}>
                Download File
              </Button>
            </div>
          </div>
